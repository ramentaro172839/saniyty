...
function VisionContainer(props) {
  ...
  let t3;
  return $[10] !== datasets || $[11] !== defaultDataset || $[12] !== projectId || $[13] !== props ? (t3 = /* @__PURE__ */ jsx(VisionGui, { ...props, datasets, projectId, defaultDataset }, projectId), $[10] = datasets, $[11] = defaultDataset, $[12] = projectId, $[13] = props, $[14] = t3) : t3 = $[14], t3;
}
