...
const ChooseNewDocumentDestinationBanner = (t0) => {
  ...
  let t3;
  $[5] !== reason || $[6] !== selectedPerspective || $[7] !== t ? (t3 = reason === "RELEASE_NOT_ACTIVE" && isReleaseDocument(selectedPerspective) && /* @__PURE__ */ jsx(Translate, { t, i18nKey: "banners.choose-new-document-destination.release-inactive", values: {
  ...
  let t5;
  $[11] !== t4 ? (t5 = /* @__PURE__ */ jsxs(Fragment, { children: [
    " ",
    t4
  ] }), $[11] = t4, $[12] = t5) : t5 = $[12];
  let t6;
  $[13] !== t2 || $[14] !== t3 || $[15] !== t5 ? (t6 = /* @__PURE__ */ jsxs(Text, { size: 1, children: [
    t2,
    t3,
    t5
  ] }), $[13] = t2, $[14] = t3, $[15] = t5, $[16] = t6) : t6 = $[16];
  let t7;
  $[17] !== menuItemProps ? (t7 = /* @__PURE__ */ jsx(ReleasesNav, { menuItemProps }), $[17] = menuItemProps, $[18] = t7) : t7 = $[18];
  let t8;
  return $[19] !== t6 || $[20] !== t7 ? (t8 = /* @__PURE__ */ jsx(Banner, { tone: "caution", icon: WarningOutlineIcon, content: /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 2, children: [
    t6,
    t7
...
const FavoriteToggle = (t0) => {
  ...
  bb1: {
    ...
    if ($[37] !== editState || $[38] !== schemaType || $[39] !== selectedPerspective ? (isSelectedPerspectiveWriteable = isPerspectiveWriteable({
      selectedPerspective,
      schemaType
    ...
    if (displayed?._id && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === !1) {
      ...
      let t182;
      $[51] !== isScheduledRelease || $[52] !== t162 || $[53] !== t172 || $[54] !== value._id ? (t182 = /* @__PURE__ */ jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t162, value: t172, isScheduledRelease }), $[51] = isScheduledRelease, $[52] = t162, $[53] = t172, $[54] = value._id, $[55] = t182) : t182 = $[55], t12 = t182;
      break bb1;
    }
    if (activeView.type === "form" && isLiveEdit && ready && editState?.draft?._id && !selectedReleaseId) {
      let t162;
      $[56] !== displayed || $[57] !== documentId || $[58] !== schemaType ? (t162 = /* @__PURE__ */ jsx(DraftLiveEditBanner, { displayed, documentId, schemaType }), $[56] = displayed, $[57] = documentId, $[58] = schemaType, $[59] = t162) : t162 = $[59], t12 = t162;
      break bb1;
    }
    ...
    let t16;
    $[60] !== showCreateBanner ? (t16 = showCreateBanner && /* @__PURE__ */ jsx(CreateLinkedBanner, {}), $[60] = showCreateBanner, $[61] = t16) : t16 = $[61];
    let t17;
    $[62] !== permissions?.granted || $[63] !== requiredPermission ? (t17 = !permissions?.granted && /* @__PURE__ */ jsx(InsufficientPermissionBanner, { requiredPermission }), $[62] = permissions?.granted, $[63] = requiredPermission, $[64] = t17) : t17 = $[64];
    let t18, t19, t20, t21, t22, t23;
    $[65] === Symbol.for("react.memo_cache_sentinel") ? (t18 = /* @__PURE__ */ jsx(RevisionNotFoundBanner, {}), t19 = /* @__PURE__ */ jsx(ReferenceChangedBanner, {}), t20 = /* @__PURE__ */ jsx(DeprecatedDocumentTypeBanner, {}), t21 = /* @__PURE__ */ jsx(CanvasLinkedBanner, {}), t22 = /* @__PURE__ */ jsx(DeletedDocumentBanners, {}), t23 = /* @__PURE__ */ jsx(UnpublishedDocumentBanner, {}), $[65] = t18, $[66] = t19, $[67] = t20, $[68] = t21, $[69] = t22, $[70] = t23) : (t18 = $[65], t19 = $[66], t20 = $[67], t21 = $[68], t22 = $[69], t23 = $[70]);
    const t24 = displayed?._id ?? documentId;
    let t25;
    $[71] !== isPinnedDraftOrPublish || $[72] !== t24 ? (t25 = /* @__PURE__ */ jsx(OpenReleaseToEditBanner, { documentId: t24, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[71] = isPinnedDraftOrPublish, $[72] = t24, $[73] = t25) : t25 = $[73];
    let t26;
    $[74] !== t16 || $[75] !== t17 || $[76] !== t25 ? (t26 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t16,
      t17,
      t18,
      t19,
  ...
  let t13;
  $[78] !== activeViewNode || $[79] !== banners || $[80] !== documentScrollElement || $[81] !== footer || $[82] !== formViewHidden || $[83] !== inspectDialog || $[84] !== layoutCollapsed || $[85] !== margins || $[86] !== portalElement || $[87] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxs(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t14;
  $[89] !== documentId || $[90] !== rootElement || $[91] !== schemaType || $[92] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[89] = documentId, $[90] = rootElement, $[91] = schemaType, $[92] = showInspector, $[93] = t14) : t14 = $[93];
  let t15;
  return $[94] !== t13 || $[95] !== t14 ? (t15 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t13,
    t14
...
const DocumentPaneProvider = memo((props) => {
  ...
  }, [getIsDeleted, isDeleting, params.rev, perspective.selectedPerspective, schemaType]), getDisplayed = useCallback((value) => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
