...
const ChooseNewDocumentDestinationBanner = (t0) => {
  ...
  }, $[0] = schemaType, $[1] = t1) : t1 = $[1];
  const menuItemProps = t1;
  let t2;
  $[2] !== reason || $[3] !== t ? (t2 = reason === "PUBLISHED_NOT_WRITEABLE" && t("banners.choose-new-document-destination.cannot-create-published-document"), $[2] = reason, $[3] = t, $[4] = t2) : t2 = $[4];
  let t3;
  $[5] !== reason || $[6] !== selectedPerspective || $[7] !== t ? (t3 = reason === "RELEASE_NOT_ACTIVE" && sanity.isReleaseDocument(selectedPerspective) && /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { t, i18nKey: "banners.choose-new-document-destination.release-inactive", values: {
    title: selectedPerspective.metadata.title
  }, components: {
    VersionBadge: sanity.getVersionInlineBadge(selectedPerspective)
  } }), $[5] = reason, $[6] = selectedPerspective, $[7] = t, $[8] = t3) : t3 = $[8];
  let t4;
  $[9] !== t ? (t4 = t("banners.choose-new-document-destination.choose-destination"), $[9] = t, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    " ",
    t4
  ] }), $[11] = t4, $[12] = t5) : t5 = $[12];
  let t6;
  $[13] !== t2 || $[14] !== t3 || $[15] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { size: 1, children: [
    t2,
    t3,
    t5
  ] }), $[13] = t2, $[14] = t3, $[15] = t5, $[16] = t6) : t6 = $[16];
  let t7;
  $[17] !== menuItemProps ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(sanity.ReleasesNav, { menuItemProps }), $[17] = menuItemProps, $[18] = t7) : t7 = $[18];
  let t8;
  return $[19] !== t6 || $[20] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone: "caution", icon: icons.WarningOutlineIcon, content: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 2, children: [
    t6,
    t7
  ] }) }), $[19] = t6, $[20] = t7, $[21] = t8) : t8 = $[21], t8;
};
...
const FavoriteToggle = (t0) => {
  ...
  bb1: {
    ...
    if ($[37] !== editState || $[38] !== schemaType || $[39] !== selectedPerspective ? (isSelectedPerspectiveWriteable = sanity.isPerspectiveWriteable({
      selectedPerspective,
      schemaType
    }), t142 = mustChooseNewDocumentDestination({
      isSelectedPerspectiveWriteable,
      editState
    }), $[37] = editState, $[38] = schemaType, $[39] = selectedPerspective, $[40] = isSelectedPerspectiveWriteable, $[41] = t142) : (isSelectedPerspectiveWriteable = $[40], t142 = $[41]), t142) {
      let t153;
      $[42] !== isSelectedPerspectiveWriteable.reason || $[43] !== isSelectedPerspectiveWriteable.result || $[44] !== schemaType || $[45] !== selectedPerspective ? (t153 = !isSelectedPerspectiveWriteable.result && /* @__PURE__ */ jsxRuntime.jsx(ChooseNewDocumentDestinationBanner, { schemaType, selectedPerspective, reason: isSelectedPerspectiveWriteable.reason }), $[42] = isSelectedPerspectiveWriteable.reason, $[43] = isSelectedPerspectiveWriteable.result, $[44] = schemaType, $[45] = selectedPerspective, $[46] = t153) : t153 = $[46], t12 = t153;
      break bb1;
    }
    if (documentInScheduledRelease) {
      const t153 = selectedPerspective;
      let t162;
      $[47] !== t153 ? (t162 = /* @__PURE__ */ jsxRuntime.jsx(ScheduledReleaseBanner, { currentRelease: t153 }), $[47] = t153, $[48] = t162) : t162 = $[48], t12 = t162;
      break bb1;
    }
    let t152;
    $[49] !== selectedPerspective ? (t152 = sanity.isSystemBundle(selectedPerspective), $[49] = selectedPerspective, $[50] = t152) : t152 = $[50];
    ...
    if (displayed?._id && sanity.getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && sanity.isNewDocument(editState) === !1) {
      ...
      let t182;
      $[51] !== isScheduledRelease || $[52] !== t162 || $[53] !== t172 || $[54] !== value._id ? (t182 = /* @__PURE__ */ jsxRuntime.jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t162, value: t172, isScheduledRelease }), $[51] = isScheduledRelease, $[52] = t162, $[53] = t172, $[54] = value._id, $[55] = t182) : t182 = $[55], t12 = t182;
      break bb1;
    }
    if (activeView.type === "form" && isLiveEdit && ready && editState?.draft?._id && !selectedReleaseId) {
      let t162;
      $[56] !== displayed || $[57] !== documentId || $[58] !== schemaType ? (t162 = /* @__PURE__ */ jsxRuntime.jsx(DraftLiveEditBanner, { displayed, documentId, schemaType }), $[56] = displayed, $[57] = documentId, $[58] = schemaType, $[59] = t162) : t162 = $[59], t12 = t162;
      break bb1;
    }
    ...
    let t16;
    $[60] !== showCreateBanner ? (t16 = showCreateBanner && /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedBanner, {}), $[60] = showCreateBanner, $[61] = t16) : t16 = $[61];
    let t17;
    $[62] !== permissions?.granted || $[63] !== requiredPermission ? (t17 = !permissions?.granted && /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionBanner, { requiredPermission }), $[62] = permissions?.granted, $[63] = requiredPermission, $[64] = t17) : t17 = $[64];
    let t18, t19, t20, t21, t22, t23;
    $[65] === Symbol.for("react.memo_cache_sentinel") ? (t18 = /* @__PURE__ */ jsxRuntime.jsx(RevisionNotFoundBanner, {}), t19 = /* @__PURE__ */ jsxRuntime.jsx(ReferenceChangedBanner, {}), t20 = /* @__PURE__ */ jsxRuntime.jsx(DeprecatedDocumentTypeBanner, {}), t21 = /* @__PURE__ */ jsxRuntime.jsx(CanvasLinkedBanner, {}), t22 = /* @__PURE__ */ jsxRuntime.jsx(DeletedDocumentBanners, {}), t23 = /* @__PURE__ */ jsxRuntime.jsx(UnpublishedDocumentBanner, {}), $[65] = t18, $[66] = t19, $[67] = t20, $[68] = t21, $[69] = t22, $[70] = t23) : (t18 = $[65], t19 = $[66], t20 = $[67], t21 = $[68], t22 = $[69], t23 = $[70]);
    const t24 = displayed?._id ?? documentId;
    let t25;
    $[71] !== isPinnedDraftOrPublish || $[72] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsx(OpenReleaseToEditBanner, { documentId: t24, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[71] = isPinnedDraftOrPublish, $[72] = t24, $[73] = t25) : t25 = $[73];
    let t26;
    $[74] !== t16 || $[75] !== t17 || $[76] !== t25 ? (t26 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t16,
      t17,
      t18,
      t19,
      ...
      t23,
      t25
    ] }), $[74] = t16, $[75] = t17, $[76] = t25, $[77] = t26) : t26 = $[77], t12 = t26;
  }
  const banners = t12, showFormView = features.resizablePanes || !showInspector;
  let t13;
  $[78] !== activeViewNode || $[79] !== banners || $[80] !== documentScrollElement || $[81] !== footer || $[82] !== formViewHidden || $[83] !== inspectDialog || $[84] !== layoutCollapsed || $[85] !== margins || $[86] !== portalElement || $[87] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    ...
    footer
  ] }), $[78] = activeViewNode, $[79] = banners, $[80] = documentScrollElement, $[81] = footer, $[82] = formViewHidden, $[83] = inspectDialog, $[84] = layoutCollapsed, $[85] = margins, $[86] = portalElement, $[87] = showFormView, $[88] = t13) : t13 = $[88];
  let t14;
  $[89] !== documentId || $[90] !== rootElement || $[91] !== schemaType || $[92] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[89] = documentId, $[90] = rootElement, $[91] = schemaType, $[92] = showInspector, $[93] = t14) : t14 = $[93];
  let t15;
  return $[94] !== t13 || $[95] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t13,
    t14
  ] }) }), $[94] = t13, $[95] = t14, $[96] = t15) : t15 = $[96], t15;
};
...
const DocumentPaneProvider = React.memo((props) => {
  ...
  }, [getIsDeleted, isDeleting, params.rev, perspective.selectedPerspective, schemaType]), getDisplayed = React.useCallback((value) => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
